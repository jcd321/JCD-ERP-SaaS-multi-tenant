...
public class GetMovementLookupsHandler : IRequestHandler<GetMovementLookupsQuery, Result<StockLookupsResult>>
{
    private readonly ISender _mediator;
    private readonly ICurrentTenantService _tenant;

    public GetMovementLookupsHandler(ISender mediator, ICurrentTenantService tenant)
    {
        _mediator = mediator;
        _tenant = tenant;
    }
    ...
    public async Task<Result<StockLookupsResult>> Handle(
        GetMovementLookupsQuery request,
