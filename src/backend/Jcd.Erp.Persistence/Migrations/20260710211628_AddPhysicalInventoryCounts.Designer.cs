...
namespace Jcd.Erp.Persistence.Migrations
{
    ...
    [Migration("20260710211628_AddPhysicalInventoryCounts")]
    partial class AddPhysicalInventoryCounts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jcd.Erp.Domain.Inventory.Adjustments.InventoryAdjustment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Jcd.Erp.Domain.Inventory.Adjustments.InventoryAdjustmentLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("AdjustmentId", "LineNumber")
                        .IsUnique()
            ...
            modelBuilder.Entity("Jcd.Erp.Domain.Inventory.Movements.InventoryMovement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Jcd.Erp.Domain.Inventory.PhysicalCounts.PhysicalInventoryCount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("physical_inventory_counts", (string)null);
                });

            modelBuilder.Entity("Jcd.Erp.Domain.Inventory.PhysicalCounts.PhysicalInventoryCountLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("CountId", "LineNumber")
                        .IsUnique()
                        .HasDatabaseName("ix_physical_inventory_count_lines_count_id_line_number");

                    b.ToTable("physical_inventory_count_lines", (string)null);
                });

            modelBuilder.Entity("Jcd.Erp.Domain.Inventory.Stock.StockLevel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Jcd.Erp.Domain.Inventory.Transfers.InventoryTransfer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Jcd.Erp.Domain.Inventory.Transfers.InventoryTransferLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Jcd.Erp.Domain.Inventory.Adjustments.InventoryAdjustmentLine", b =>
                {
                    b.HasOne("Jcd.Erp.Domain.Inventory.Adjustments.InventoryAdjustment", "Adjustment")
                        .WithMany("Lines")
                        .HasForeignKey("AdjustmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Jcd.Erp.Domain.Catalog.Products.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Jcd.Erp.Domain.Inventory.PhysicalCounts.PhysicalInventoryCountLine", b =>
                {
                    b.HasOne("Jcd.Erp.Domain.Inventory.PhysicalCounts.PhysicalInventoryCount", "Count")
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("Jcd.Erp.Domain.Inventory.Transfers.InventoryTransfer", b =>
                {
                    b.HasOne("Jcd.Erp.Domain.Inventory.Warehouses.Warehouse", "DestinationWarehouse")
                        .WithMany()
                        .HasForeignKey("DestinationWarehouseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Jcd.Erp.Domain.Inventory.Warehouses.Warehouse", "SourceWarehouse")
                        .WithMany()
            ...
            modelBuilder.Entity("Jcd.Erp.Domain.Inventory.Transfers.InventoryTransferLine", b =>
                {
                    ...
                    b.HasOne("Jcd.Erp.Domain.Inventory.Transfers.InventoryTransfer", "Transfer")
                        .WithMany("Lines")
