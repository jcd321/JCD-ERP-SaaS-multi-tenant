...
const PLATFORM_ERROR_KEYS: Record<string, string> = {
  ...
  'Adjustment.WarehouseNotFound': 'errors.adjustmentWarehouseNotFound',
  'Adjustment.WarehouseInactive': 'errors.adjustmentWarehouseInactive',
  'Adjustment.WarehouseRequired': 'errors.adjustmentWarehouseRequired',
  'Adjustment.ReasonRequired': 'errors.adjustmentReasonRequired',
  'Adjustment.LinesRequired': 'errors.adjustmentLinesRequired',
  'Adjustment.DuplicateProduct': 'errors.adjustmentDuplicateProduct',
  'Adjustment.ProductNotFound': 'errors.adjustmentProductNotFound',
  'Adjustment.ProductInactive': 'errors.adjustmentProductInactive',
  'Adjustment.ProductRequired': 'errors.adjustmentProductNotFound',
  'Adjustment.NoChange': 'errors.adjustmentNoChange',
  'Adjustment.InsufficientStock': 'errors.adjustmentInsufficientStock',
  'Adjustment.QuantityInvalid': 'errors.adjustmentQuantityInvalid',
  'Adjustments.LoadFailed': 'errors.adjustmentsLoadFailed',
  'Adjustments.LookupsLoadFailed': 'errors.adjustmentsLookupsLoadFailed',
  'Adjustments.CreateFailed': 'errors.adjustmentsCreateFailed',
