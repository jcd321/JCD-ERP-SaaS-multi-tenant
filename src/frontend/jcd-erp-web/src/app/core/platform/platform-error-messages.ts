...
const PLATFORM_ERROR_KEYS: Record<string, string> = {
  ...
  'PhysicalCount.WarehouseNotFound': 'errors.physicalCountWarehouseNotFound',
  'PhysicalCount.WarehouseInactive': 'errors.physicalCountWarehouseInactive',
  'PhysicalCount.NoStockInWarehouse': 'errors.physicalCountNoStockInWarehouse',
  'PhysicalCount.NotFound': 'errors.physicalCountNotFound',
  'PhysicalCount.NotEditable': 'errors.physicalCountNotEditable',
  'PhysicalCount.LineNotFound': 'errors.physicalCountLineNotFound',
  'PhysicalCount.NoCountedLines': 'errors.physicalCountNoCountedLines',
  'PhysicalCount.InsufficientStock': 'errors.physicalCountInsufficientStock',
  'PhysicalCount.QuantityInvalid': 'errors.physicalCountQuantityInvalid',
  'PhysicalCounts.LoadFailed': 'errors.physicalCountsLoadFailed',
  'PhysicalCounts.LookupsLoadFailed': 'errors.physicalCountsLookupsLoadFailed',
  'PhysicalCounts.CreateFailed': 'errors.physicalCountsCreateFailed',
  'PhysicalCounts.UpdateFailed': 'errors.physicalCountsUpdateFailed',
  'PhysicalCounts.CompleteFailed': 'errors.physicalCountsCompleteFailed',
  'PhysicalCounts.CancelFailed': 'errors.physicalCountsCancelFailed',
